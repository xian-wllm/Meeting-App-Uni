...
{{/*
    Create URL of datasources JDBC
*/}}

{{- define "spark.jdbcURL" -}}
jdbc:postgresql://{{ .Release.Name }}-postgresql:{{ .Values.datasource.port }}/{{ .Values.datasource.database }}
{{- end }}

{{- define "quarkus.datasource" }}
            - name: QUARKUS_DATASOURCE_JDBC_URL
              value: {{ include "spark.jdbcURL" . }}
